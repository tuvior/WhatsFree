...
public class CommunicationLayer {
    ...
    private static final String SERVER_URL = "HttpExample";
     ...
     */
    public CommunicationLayer(String serverUrl) {
     ...
     */
    public String sendLogInInfo(LogInInfo logInInfo) {
     ...
     * @return "ok" if the operation was successful, or "failed" otherwise
     */
    public String sendRegistrationInfo(RegistrationInfo registrationInfo){
