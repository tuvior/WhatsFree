...
public class ServerDeleteUser {
    ...
    private String getStatusFromJson(JSONObject serverResponse) throws JSONException {
        return serverResponse.getJSONObject("delete user").getString("status");
    }

    private String getReasonFromJson(JSONObject serverResponse) throws JSONException {
        return serverResponse.getJSONObject("delete user").getString("reason");
    }
    ...
    public void serverRespondsWithFailureIfNoSuchUser() throws CommunicationLayerException, JSONException {
        ...
        assertEquals("failure", getStatusFromJson(serverResponse));
        assertEquals("no such user", getReasonFromJson(serverResponse));
    }

    @Test
    public void serverRespondsWithOkIfSuccess() throws CommunicationLayerException, JSONException {
        establishConnectionAndReturnJsonResponse("/delete/user?name=deleteTest", "GET");
