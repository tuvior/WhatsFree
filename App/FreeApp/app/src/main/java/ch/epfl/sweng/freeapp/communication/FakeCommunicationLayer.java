...
public class FakeCommunicationLayer implements DefaultCommunicationLayer {
    ...
    private Submission freeCroissants = new Submission("Free Croissants", "There's a huge croissant giveaway at Flon!", SubmissionCategory.Food, "Presidence de la polynesie francaise", image);
    private Submission freeDonuts =  new Submission("Free Donuts", "Migros gives a free dozen to the first 5 customers",SubmissionCategory.Food, "Motu Uta", image);
    private Submission unicornDiscount = new Submission("Unicorn Discount", "Get one of our wonderful white unicorns!", SubmissionCategory.Miscellaneous, "Papeete Tahiti Temple", image);
    private Submission freeClubEntrance  = new Submission("Free Entrance Tonight", "Come get wasted for free tonight!", SubmissionCategory.Nightlife, "Port de Papeete", image);
